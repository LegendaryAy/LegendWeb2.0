...
namespace LegendWeb.Migrations
{
    ...
    [Migration("20220104094221_newProjects")]
            ...
            modelBuilder.Entity("LegendWeb.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5508bc64-27f0-4521-b43c-67011c4af908",
                            City = "Lagos",
                            Country = "Nigeria",
            ...
            modelBuilder.Entity("LegendWeb.Models.Projects", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "018aecf1-e52f-4339-947e-5f5c79087b78",
                        ...
                        new
                        {
                            Id = "0ea5bf42-9283-4454-adc6-20476564c0aa",
                        ...
                        new
                        {
                            Id = "a939f9e5-14eb-44db-ac6c-d29fc501c7c3",
                        ...
                        new
                        {
                            Id = "b7b5f8cc-597f-4133-b2ec-8272e290c778",
                        ...
                        new
                        {
                            Id = "18a362e4-5da5-4e61-9bb6-ccd066d85122",
                        ...
                        new
                        {
                            Id = "c82c30d2-bbfe-4ef2-8525-b2cf3175d26a",
            ...
            modelBuilder.Entity("LegendWeb.Models.Skills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "936e1ddd-3e1b-45be-9a96-fa02db9e8623",
                            Name = "HTML",
                            Progress = 100,
                            UserId = "1"
                        },
                        new
                        {
                            Id = "50bb5031-aea6-4817-925f-c48e3c14de7b",
                            Name = "CSS",
                            Progress = 95,
                            UserId = "1"
                        },
                        new
                        {
                            Id = "07a4ec83-6de6-4514-b94f-a748c6a12979",
                            Name = "JavaScript",
                            Progress = 89,
                            UserId = "1"
                        },
                        new
                        {
                            Id = "3a1cb135-deba-41f4-a463-eef04f777751",
                            Name = "C#",
                            Progress = 90,
                            UserId = "1"
                        },
                        new
                        {
                            Id = "3ae9008b-75c6-4aeb-93d6-29077ce09104",
                            Name = "SQL",
                            Progress = 82,
                            UserId = "1"
                        },
                        new
                        {
                            Id = "f21b0b1e-51c4-4afc-82e3-2713de5793b1",
                            Name = "PHP",
                            Progress = 86,
                            UserId = "1"
                        });
